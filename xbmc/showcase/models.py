...
class Actorlinkepisode(models.Model):
    idactor = models.IntegerField(db_column='idActor', primary_key=True) # Field name made lowercase.
    ...
    class Meta:
        if settings.XBMC_MODELS_UNMANAGED:
            managed = False
        db_table = 'actorlinkepisode'
        unique_together = (('idactor', 'idepisode'),)
...
class Actorlinktvshow(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('idactor', 'idshow'),)
...
class Artistlinkmusicvideo(models.Model):
    idartist = models.IntegerField(db_column='idArtist', primary_key=True) # Field name made lowercase.
    ...
    class Meta:
        ...
        unique_together = (('idartist', 'idmvideo'),)
...
class Countrylinkmovie(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('idcountry', 'idmovie'),)
...
class Genrelinkmovie(models.Model):
    idgenre = models.IntegerField(db_column='idGenre', primary_key=True) # Field name made lowercase.
    idmovie = models.IntegerField(db_column='idMovie', blank=True, null=True) # Field name made lowercase.
    class Meta:
        if settings.XBMC_MODELS_UNMANAGED:
            managed = False
        db_table = 'genrelinkmovie'
        unique_together = (('idgenre', 'idmovie'),)
...
class Genrelinkmusicvideo(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('idgenre', 'idmvideo'),)
...
class Genrelinktvshow(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('idgenre', 'idshow'),)
...
class Movie(models.Model):
    ...
    #idfile = models.IntegerField(db_column='idFile', blank=True, null=True) # Field name made lowercase.
    file = models.ForeignKey(Files, db_column='idFile')
    c00 = models.TextField(blank=True)
    c01 = models.TextField(blank=True)
    c02 = models.TextField(blank=True)
    c03 = models.TextField(blank=True)
    ...
    idset = models.ForeignKey(Sets, db_column='idSet', blank=True, null=True) # Field name made lowercase.

    writers = models.ManyToManyField(Actors, through='Writerlinkmovie', through_fields=('movie', 'writer'), related_name='movies_written')
    
    directors = models.ManyToManyField(Actors, through='Directorlinkmovie', through_fields=('movie', 'director'), related_name='movies_directed')
...
class Movielinktvshow(models.Model):
    idmovie = models.IntegerField(db_column='idMovie', primary_key=True) # Field name made lowercase.
    idshow = models.IntegerField(db_column='IdShow', blank=True, null=True) # Field name made lowercase.
    class Meta:
        if settings.XBMC_MODELS_UNMANAGED:
            managed = False
        db_table = 'movielinktvshow'
        unique_together = (('idmovie', 'idshow'),)
...
class Settings(models.Model):
    idfile = models.IntegerField(db_column='idFile', unique=True, primary_key=True) # Field name made lowercase.
...
class Streamdetails(models.Model):
    #idfile = models.IntegerField(db_column='idFile', blank=True, null=True) # Field name made lowercase.
    file = models.ForeignKey(Files, db_column='idFile', primary_key=True)
    ...
    class Meta:
        ...
        unique_together = (('file', 'istreamtype'),)
...
class Studiolinkmovie(models.Model):
    idstudio = models.IntegerField(db_column='idStudio', primary_key=True) # Field name made lowercase.
    idmovie = models.IntegerField(db_column='idMovie', blank=True, null=True) # Field name made lowercase.
    class Meta:
        if settings.XBMC_MODELS_UNMANAGED:
            managed = False
        db_table = 'studiolinkmovie'
        unique_together = (('idstudio', 'idmovie'),)
...
class Studiolinkmusicvideo(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('idstudio', 'idmvideo'),)
...
class Studiolinktvshow(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('idstudio', 'idshow'),)
...
class Taglinks(models.Model):
    idtag = models.IntegerField(db_column='idTag', primary_key=True) # Field name made lowercase.
...
class Tvshowlinkpath(models.Model):
    idshow = models.IntegerField(db_column='idShow', primary_key=True) # Field name made lowercase.
    idpath = models.IntegerField(db_column='idPath', blank=True, null=True) # Field name made lowercase.
    class Meta:
        if settings.XBMC_MODELS_UNMANAGED:
            managed = False
        db_table = 'tvshowlinkpath'
        unique_together = (('idshow', 'idpath'),)

class Version(models.Model):
    idversion = models.IntegerField(db_column='idVersion', primary_key=True) # Field name made lowercase.
...
class Writerlinkmovie(models.Model):
    #idwriter = models.IntegerField(db_column='idWriter', primary_key=True) # Field name made lowercase.
    writer = models.ForeignKey(Actors, db_column='idWriter', primary_key=True) # Field name made lowercase.
    # idmovie = models.IntegerField(db_column='idMovie', blank=True, null=True) # Field name made lowercase.
    movie = models.ForeignKey(Movie, db_column='idMovie', blank=True, null=True) # Field name made lowercase.
    class Meta:
        if settings.XBMC_MODELS_UNMANAGED:
            managed = False
...
class Directorlinkepisode(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('iddirector', 'idepisode'),)

class Directorlinkmovie(models.Model):
    director = models.ForeignKey(Actors, db_column='idDirector', primary_key=True) # Field name made lowercase.
    movie = models.ForeignKey(Movie, db_column='idMovie', blank=True, null=True) # Field name made lowercase.
    class Meta:
        if settings.XBMC_MODELS_UNMANAGED:
            managed = False
...
class Directorlinkmusicvideo(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('iddirector', 'idmvideo'),)
...
class Directorlinktvshow(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('iddirector', 'idshow'),)

class Actorlinkmovie(models.Model):
    #idactor = models.IntegerField(db_column='idActor', primary_key=True) # Field name made lowercase.
    #idmovie = models.IntegerField(db_column='idMovie', blank=True, null=True) # Field name made lowercase.
    actor = models.ForeignKey(Actors, db_column='idActor', primary_key=True) # Field name made lowercase.
    movie = models.ForeignKey(Movie, db_column='idMovie', blank=True, null=True) # Field name made lowercase.
    strrole = models.TextField(db_column='strRole', blank=True) # Field name made lowercase.
    iorder = models.IntegerField(db_column='iOrder', blank=True, null=True) # Field name made lowercase.
    class Meta:
        ...
        #unique_together = (('idactor', 'idmovie'),)
        ordering = ('iorder',)
